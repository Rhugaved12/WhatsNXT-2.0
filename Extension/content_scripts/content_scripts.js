...
function getContext(number_of_msgs) {
  ...
  console.log("Myname and context")
  console.log(myname)
  console.log(context)
...
function getCalendarResults(calendar_context) {
  // calendar_context = [context, messageDOMs, authors, myname]
  var context = calendar_context[0];
...
function getAutocompleteResults(context) {
  ...
  $.ajax({
    ...
    dataType: "json",
    data: { context: context, chat_name: chat_name },
    success: (res) => {
      wordcomplete = [res.COMPLETE, res.PREDICT, res.MANUAL];
      autocomplete = "";
...
function displayAutocompleteResults(words, prompts, context, key_pressed) {
  ...
  $(".prompt").on("click", function () {
    ...
    console.log("1Mouse Clicked. Current Message:")
  ...
  $(".complete").on("click", function () {
    ...
    console.log(currentMessage)
    console.log(document.getElementsByClassName('_3Uu1_')[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].data)
    ...
    $('div[data-tab="10"]').siblings().hide();
    // document.getElementsByClassName('_3Uu1_')[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].data = ""
    //   document.getElementsByClassName('_3Uu1_')[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].data = currentMessage
    // console.log(document.getElementsByClassName('_3Uu1_')[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].data)
