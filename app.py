...
#     '../emotion_detection/emotion_pipeline_model.pickle', 'rb'))
...
# modelPipeline = pipeline(
#     'text-generation', model='../rhugaved_without_name/output')
...
def autocomplete():
    ...
    new_result = []
    for r in result:
        new_result.append({'generated_text': r})
    print(new_result)
    res = jsonify({
